				...
				new AbstractAction() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						if (zsbScanValueSplitted[0].length() != zsbLength) {
							zsbNotFoundLabel.setText("ZSB ГРЕШКА!");
							ZSB_field.setText("");
						} else {
							...
							if (isFolderFound) {
								...
								for (int x = 0; x < listProgramsName.length; x++) {
									...
									if (listProgramsName[x].getName().equals(
										...
										JTextArea labelIncludedVariantsArea = new JTextArea("УЧАСТВАЩИ КАБЕЛИ");
										...
										JTextArea pathToZSBlabel = new JTextArea("Път към .ETK файл: "
														+ pathToETKfile);
										...
										for (int i = 0; i < finalRepeatedRows.length; i++) {
											...
											if (((i + 1) > 8)
												...
												if ((i + 1) > 30) {
													includedVariantsArea
															.append("Прекалено много варианти за показване");
...
////////////////////////////////////////////////////////////////////////////////////////////////////
										...
										final JTextField scanETK_FieldInfo = new JTextField(
												"Сканирай:"+ finalRepeatedRows[0][1]);
										...
										frame.getRootPane().getActionMap().put("clickButton",
												...
												for (int i = 0; i < finalRepeatedRows.length; i++) {
													...
													scanETK_FieldInfo.setText("Сканирай:"
							...
							////////////////////////////////////////////////////////////////////////////////////////////////////
										...
										zsbNotFoundLabel.setText("ZSB не е открито!");
